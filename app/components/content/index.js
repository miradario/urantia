...
class Content extends Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (current.PaperNr !== route.PaperNr || current.PaperSec !== route.PaperSec) {
    ...
    onViewableItemsChanged = (index) => {
        ...
        if (content[0]) {
            ...
            console.log("Current vs Prev PaperNr", PaperNr, this.props.route.params.PaperNr);
        ...
        return (
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor }}>
                <FlatList 
                    ...
                    onResponderMove={(e) => {
                        ...
                        if (origin !== undefined){
                            ...
                            if ((deg >= -35 && deg <= 35) && mag > 40) {
                                setTimeout(() => {
                                    onSwipeLeft();
                                    this.scrollView.current.scrollToOffset({ offset: 0, animated: false });
                                });
                    ...
                    wait.then(() => {
                        this.scrollView.current?.scrollToIndex({ index: info.index, animated: true });
                    });
                    }}
